package com.example.bariuas2.activity.pemasok;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView namaPemasok = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(namaPemasok);
        TextView kontakPemasok = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(kontakPemasok);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("Nama Pemasok: %s", data.namaPemasok));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Kontak Pemasok: %s", data.kontakPemasok));
    ...
    private void showUpdateModal(Model model) {
        ...
        // TODO Edit This Scarlet
        EditText namaPemasok = Utils.createEditText(context, "namaPemasok");
        namaPemasok.setText(model.namaPemasok);
        updateContainer.addView(namaPemasok);
        EditText kontakPemasok = Utils.createEditText(context, "kontakPemasok");
        kontakPemasok.setText(model.kontakPemasok);
        updateContainer.addView(kontakPemasok);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.namaPemasok, namaPemasok.getText().toString())) {
                updatedModel.put("namaPemasok", namaPemasok.getText().toString());
            }
            if (!Objects.equals(model.kontakPemasok, kontakPemasok.getText().toString())) {
                updatedModel.put("kontakPemasok", kontakPemasok.getText().toString());
            }
