...
public class Activity extends AppCompatActivity {
    ...
    private void showCreateModal() {
        ...
        EditText barangId = Utils.createEditText(this, "barangId");
        inputContainer.addView(barangId);
        EditText pemasokId = Utils.createEditText(this, "pemasokId");
        inputContainer.addView(pemasokId);
        EditText karyawanId = Utils.createEditText(this, "karyawanId");
        inputContainer.addView(karyawanId);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    pemasokId.getText().toString(),
                    karyawanId.getText().toString()
            );
