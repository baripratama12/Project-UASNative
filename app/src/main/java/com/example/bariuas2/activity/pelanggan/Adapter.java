...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView namaPelanggan = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(namaPelanggan);
        TextView kontakPelanggan = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(kontakPelanggan);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("Nama Pelanggan: %s", data.namaPelanggan));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Kontak Pelanggan: %s", data.kontakPelanggan));
    ...
    private void showUpdateModal(Model model) {
        ...
        // TODO Edit This Scarlet
        EditText namaPelanggan = Utils.createEditText(context, "namaPelanggan");
        namaPelanggan.setText(model.namaPelanggan);
        updateContainer.addView(namaPelanggan);
        EditText kontakPelanggan = Utils.createEditText(context, "kontakPelanggan");
        kontakPelanggan.setText(model.kontakPelanggan);
        updateContainer.addView(kontakPelanggan);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.namaPelanggan, namaPelanggan.getText().toString())) {
                updatedModel.put("namaPelanggan", namaPelanggan.getText().toString());
            }
            if (!Objects.equals(model.kontakPelanggan, kontakPelanggan.getText().toString())) {
                updatedModel.put("kontakPelanggan", kontakPelanggan.getText().toString());
            }
