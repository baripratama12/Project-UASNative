...
public class Activity extends AppCompatActivity {
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText namaPemasok = Utils.createEditText(this, "namaPemasok");
        inputContainer.addView(namaPemasok);
        EditText kontakPemasok = Utils.createEditText(this, "kontakPemasok");
        inputContainer.addView(kontakPemasok);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    // TODO Edit This Scarlet
                    namaPemasok.getText().toString(),
                    kontakPemasok.getText().toString()
            );
