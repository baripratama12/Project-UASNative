...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("Pelanggan");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText namaPelanggan = Utils.createEditText(this, "namaPelanggan");
        inputContainer.addView(namaPelanggan);
        EditText kontakPelanggan = Utils.createEditText(this, "kontakPelanggan");
        inputContainer.addView(kontakPelanggan);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    kontakPelanggan.getText().toString()
            );
