...
import com.example.bariuas2.Config;
...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("Transaksi");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText gudangId = Utils.createEditText(this, "gudangId");
        inputContainer.addView(gudangId);
        EditText pelangganId = Utils.createEditText(this, "pelangganId");
        inputContainer.addView(pelangganId);
        EditText tanggal = Utils.createEditText(this, "tanggal");
        inputContainer.addView(tanggal);
        EditText jumlah = Utils.createEditText(this, "jumlah");
        inputContainer.addView(jumlah);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    // TODO Edit This Scarlet
                    gudangId.getText().toString(),
                    pelangganId.getText().toString(),
