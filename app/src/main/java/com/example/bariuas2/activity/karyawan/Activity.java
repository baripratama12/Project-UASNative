...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("Karyawan");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText namaKaryawan = Utils.createEditText(this, "namaKaryawan");
        inputContainer.addView(namaKaryawan);
        EditText durasi = Utils.createEditText(this, "durasi");
        inputContainer.addView(durasi);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    // TODO Edit This Scarlet
                    namaKaryawan.getText().toString(),
                    Integer.parseInt(durasi.getText().toString())
            );
