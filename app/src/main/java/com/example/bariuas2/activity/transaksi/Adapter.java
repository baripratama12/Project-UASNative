...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView gudangId = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(gudangId);
        TextView pelangganId = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(pelangganId);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("ID Gudang: %s", data.gudangId));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("ID Pelanggan: %s", data.pelangganId));
        ((TextView) holder.itemCountainer.getChildAt(2)).setText(String.format("Tanggal Transaksi: %s", data.tanggal));
        ((TextView) holder.itemCountainer.getChildAt(3)).setText(String.format("Jumlah Barang: %s", data.jumlah));
    ...
    private void showUpdateModal(Model model) {
        ...
        // TODO Edit This Scarlet
        EditText gudangId = Utils.createEditText(context, "gudangId");
        gudangId.setText(model.gudangId);
        updateContainer.addView(gudangId);
        EditText pelangganId = Utils.createEditText(context, "pelangganId");
        pelangganId.setText(model.pelangganId);
        updateContainer.addView(pelangganId);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.gudangId, gudangId.getText().toString())) {
                updatedModel.put("gudangId", gudangId.getText().toString());
            }
            if (!Objects.equals(model.pelangganId, pelangganId.getText().toString())) {
                updatedModel.put("pelangganId", pelangganId.getText().toString());
            }
