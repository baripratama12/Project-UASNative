...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView namaKaryawan = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(namaKaryawan);
        TextView durasi = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(durasi);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("Nama Karyawan: %s", data.namaKaryawan));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Durasi Kerja: %s", data.durasi));
    ...
    private void showUpdateModal(Model model) {
        ...
        // TODO Edit This Scarlet
        EditText namaKaryawan = Utils.createEditText(context, "namaKaryawan");
        namaKaryawan.setText(model.namaKaryawan);
        updateContainer.addView(namaKaryawan);
        EditText durasi = Utils.createEditText(context, "durasi");
        durasi.setText(model.durasi.toString());
        updateContainer.addView(durasi);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.namaKaryawan, namaKaryawan.getText().toString())) {
                updatedModel.put("namaKaryawan", namaKaryawan.getText().toString());
            }
            if (!Objects.equals(model.durasi, durasi.getText().toString())) {
                updatedModel.put("durasi", durasi.getText().toString());
            }
